...
1. A code has been written that will allow you to write features in the future
2. The practice of testing and CI/CD has been implemented 
3. Linters, formatters, and link checker have been added
